...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="adminLTE/assets/images/favicon.png">
    <title>Adminmart Template - The Ultimate Multipurpose admin template</title>
    <!-- Custom CSS -->
    <link href="adminLTE/assets/extra-libs/c3/c3.min.css" rel="stylesheet">
    <link href="adminLTE/assets/libs/chartist/dist/chartist.min.css" rel="stylesheet">
    <link href="adminLTE/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
    <!-- Custom CSS -->
    <link href="../adminLTE/dist/css/style.min.css" rel="stylesheet">
    <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    <!--Datatable-->
    <script src="adminLTE/assets/libs/jquery/dist/jquery.min.js"></script>
    <link href="adminLTE/assets/extra-libs/datatables.net-bs4/css/dataTables.bootstrap4.css" rel="stylesheet">
...
<body>
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index.html">
                            <b class="logo-icon">
                                ...
                                <!-- Light Logo icon -->
                                <img src="adminLTE/assets/images/logo-icon.png" alt="homepage" class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                            <span class="logo-text">
                                ...
                                <!-- Light Logo text -->
                                <img src="adminLTE/assets/images/logo-light-text.png" class="light-logo"
                                    alt="homepage" />
                            </span>
                        </a>
                    </div>
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <img src="adminLTE/assets/images/users/profile-pic.jpg" alt="user"
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="{{route('admin-category.index')}}"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                                    class="hide-menu">Product
                                </span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{url('list')}}"
                                aria-expanded="false"><i data-feather="message-square" class="feather-icon"></i><span
                                    class="hide-menu">List</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{url('exam')}}"
                                aria-expanded="false"><i data-feather="calendar" class="feather-icon"></i><span
                                    class="hide-menu">Exam</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{url('table2021')}}"
                                aria-expanded="false"><i data-feather="calendar" class="feather-icon"></i><span
                                    class="hide-menu">Player</span></a></li>
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page">@yield('title')
                                    </li>
                                </ol>
                            </nav>
                        </div>
    ...
    <!-- ============================================================== -->
    <script src="adminLTE/assets/libs/jquery/dist/jquery.min.js"></script>
    <script src="adminLTE/assets/libs/popper.js/dist/umd/popper.min.js"></script>
    <script src="adminLTE/assets/libs/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- apps -->
    <!-- apps -->
    <script src="adminLTE/dist/js/app-style-switcher.js"></script>
    <script src="adminLTE/dist/js/feather.min.js"></script>
    <script src="adminLTE/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
    <script src="adminLTE/dist/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="adminLTE/dist/js/custom.min.js"></script>
    <!--This page JavaScript -->
    <script src="adminLTE/assets/extra-libs/c3/d3.min.js"></script>
    <script src="adminLTE/assets/extra-libs/c3/c3.min.js"></script>
    <script src="adminLTE/assets/libs/chartist/dist/chartist.min.js"></script>
    <script src="adminLTE/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"></script>
    <script src="adminLTE/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.min.js"></script>
    <!--script src="adminLTE/assets/extra-libs/jvector/jquery-jvectormap-world-mill-en.js"></script>
    <!--script src="adminLTE/dist/js/pages/dashboards/dashboard1.min.js"></!--script>
    ...
    <script src="adminLTE/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
    <script src="adminLTE/assets/extra-libs/sparkline/sparkline.js"></script>
    <!--Wave Effects -->
    <!-- themejs -->
    <!--Menu sidebar -->
    <script src="adminLTE/dist/js/sidebarmenu.js"></script>
    ...
    <script src="adminLTE/dist/js/custom.min.js"></script>
    <!--This page plugins -->
    <script src="adminLTE/assets/extra-libs/datatables.net/js/jquery.dataTables.min.js"></script>
    <script src="adminLTE/dist/js/pages/datatable/datatable-basic.init.js"></script>
