...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="../assets/images/hmjti.png">
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="{{url('/')}}">
                            <div class="">
                                <!-- Dark Logo icon -->
                                <img src="{{URL::asset('assets/images/hmjti.png')}}" height="50px" alt="homepage"
                                    class="dark-logo" />
                                <!-- Light Logo icon -->
                                <img src="{{URL::asset('assets/images/hmjti.png')}}" height="50px" alt="homepage"
                                    class="light-logo" />
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <img src="{{URL::asset('assets/images/users/profile-pic.jpg')}}" alt="user"
        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item text-dark"> <a class="sidebar-link sidebar-link" href="{{url('home')}}"
                                aria-expanded="false"><i data-feather="home" class="feather-icon"></i><span
                                    class="hide-menu">Dashboard</span></a></li>



                        <li class="sidebar-item"> <a class="sidebar-link" href="{{route('admin-inventory.index')}}"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                                    class="hide-menu">Inventaris
                                </span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link"
                                href="{{route('admin-category.index')}}" aria-expanded="false"><i
